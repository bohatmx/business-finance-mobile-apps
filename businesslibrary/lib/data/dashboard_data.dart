...
class DashboardData {
  int totalOpenOffers = 0,
      ...
      deliveryNotes = 0,
      cancelledOffers = 0,
      closedOffers = 0, totalSettlements = 0;
  double totalOpenOfferAmount = 0.00,
      ...
      averageDiscountPerc = 0.0, totalSettlementAmount = 0.00;
  String date;
  List<InvoiceBid> unsettledBids, settledBids;
  List<Offer> openOffers;
  List<InvestorInvoiceSettlement> settlements;

  DashboardData({this.totalOpenOffers, this.totalUnsettledBids,
      this.totalSettledBids, this.totalBids, this.totalOffers,
      this.purchaseOrders, this.invoices, this.deliveryNotes,
      this.cancelledOffers, this.closedOffers, this.totalSettlements,
      this.totalSettlementAmount, this.totalOpenOfferAmount,
      this.totalUnsettledAmount, this.totalSettledAmount, this.totalBidAmount,
      this.totalOfferAmount, this.averageBidAmount,
      this.totalPurchaseOrderAmount, this.totalDeliveryNoteAmount,
 ...
 */
  ...
  DashboardData.fromJson(Map data) {
    ...
    List<dynamic> settlementsBidMaps = data['settlements'];
    List<dynamic> offersBidMaps = data['openOffers'];
    ...
    settlements = List();
    settlementsBidMaps.forEach((map) {
      var iis = InvestorInvoiceSettlement.fromJson(map);
      settlements.add(iis);
    });
    openOffers = List();
    offersBidMaps.forEach((map) {
