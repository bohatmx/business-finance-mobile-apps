...
class _MyHomePageState extends State<MyHomePage>
  ...
  _start() async {
    print('_MyHomePageState._start ..... Timer.periodic(Duration(seconds: 10)');
    Timer.periodic(Duration(seconds: 30), (count) async {
      _index = 0;
      _offers = await ListAPI.getOpenOffers();
      _doTradesForAll();
    });
      ...
      if (_offers.isEmpty) {
        ...
        if (_offers.isEmpty) {
          AppSnackbar.showSnackbar(
              ...
              backgroundColor: Styles.black);
          print(
              '_MyHomePageState._doTradesForAll - no open offers found. will try in 30 seconds: ${DateTime.now().toIso8601String()}');
        } else {
          _doTradesForAll();
          return;
        }
